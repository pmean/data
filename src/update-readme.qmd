...
```{r top-half}
write_lines(backup_text[1:dividing_line], "../README.md")
# Add a blank line
...
for (y in yamls) {
  ...
  write_file(bullet1, "../README.md", append=TRUE)
  write_lines(glue(line1), "../README.md", append=TRUE)
  write_file(bullet2, "../README.md", append=TRUE)
  write_lines(glue(line2), "../README.md", append=TRUE)
  write_file(bullet2, "../README.md", append=TRUE)
  write_lines(glue(line3), "../README.md", append=TRUE)
